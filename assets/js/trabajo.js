...
$(document).ready(function () {
  $("#categoria").change(function () {
    $("#categoria option:selected").each(function () {
      ...
      $.post(
        "<?php  echo base_url()?>trabajos/nuevo/fillsubcategorias",
        {
...
$(document).ready(function () {
  $("#categoria").change(function () {
    $("#categoria option:selected").each(function () {
      ...
      $.post(
        "<?php  echo base_url()?>trabajos/nuevo/filldependencias",
        {
...
$(document).ready(function () {
  $("#txt_fecha").each(function (index, value) {
...
function cantidad_cambiada() {
  ...
  $.post(
    "<?php  echo base_url()?>trabajos/nuevo/activFecha",
    {
      txt_fecha: txt_fecha,
    },
    function (data) {
...
$(document).ready(function () {
  $(".btn-editar").click(function () {
    idwork = $(this).attr("id");
    $.post(
      "<?php  echo base_url()?>trabajos/nuevo/funwork",
      {
        idwork: idwork,
      },
      function (data) {
