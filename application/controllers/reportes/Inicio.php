...
class  inicio extends CI_Controller {
	...
	function informes (){
		...
		if(empty($year)) {$year = $this->input->post('year');}
		if(empty($mes)) {$mes = $this->input->post('mes');}
		if(empty($tipo_fun)) {$tipo_fun = $this->input->post('tipo_fun');}
		if(empty($tipo_inst)) {$tipo_inst = $this->input->post('tipo_inst');}
		if(empty($fun)) {$fun = $this->input->post('fun');}
		if(empty($work_categorias)) {$work_categorias = $this->input->post('work_categorias');}
		if(empty($work_subcategoria)) {$work_subcategoria = $this->input->post('work_subcategoria');}
