...
$directorio_instituto = getcwd().'/assets/img/instituto';
	...
	//echo "paso".$directorio_actividades.'/'.$titulo_cambiado;
		...
		if (!file_exists($directorio_actividades.'/'.$titulo_cambiado )) {
			if(!mkdir($directorio_actividades.'/'.$titulo_cambiado, 0777, true)) {
				die('Fallo al crear las carpetas...');
            }else{
                //echo'Creo la carpeta: '.$directorio_actividades.'/'.$titulo_cambiado.'<br>';
	...
	if ($instituto==1) {
		...
		if (!file_exists($directorio_instituto.'/'.$titulo_cambiado )) {
			if(!mkdir($directorio_instituto.'/'.$titulo_cambiado, 0777, true)) {
				die('Fallo al crear las carpetas...');
            }else{
            	echo 'Creo la carpeta: '.$directorio_instituto.'/'.$titulo_cambiado.'<br>';
            	$fecha = $this->input->post('txt_fecha');
				$descripcion = $this->input->post('txt_descripcion');
				$foto_principal = $this->input->post('foto_principal');
				/*la carpeta donde ira*/
