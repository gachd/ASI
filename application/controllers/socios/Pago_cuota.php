...
foreach($idsocio as $row_is){
    ...
    if($corp == '65106820-7'){$valor = $stadio;}

    if($corp == '71888800-k'){$valor = $atletico;}

    if($corp == '72265900-7'){$valor = $concordia;}

    if($corp == '70331500-3'){$valor = $centro;}

    if($corp == '65467840-5'){$valor = $scuola;} 
