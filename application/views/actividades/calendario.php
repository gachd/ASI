...
<style>
	...
	.categoria{width: 20px; float:left;}
	.text-categoria{ margin-left:10px;}

	 .fc-center h2{ text-transform: uppercase; }</style>
</head>
<body>
 ...
 <div class="main">
 	<nav class="navbar navbar-default nav-titulo">
        ...
        <div class="padre buscador1">
        	<div class="hijo">
        		  <div class="col-md-3"><div style="background:#064b70;" class="categoria">&nbsp;</div><span class="text-categoria">Scuola</span></div>
             <div class="col-md-3"><div style="background:#4b7006;" class="categoria">&nbsp;</div><span class="text-categoria"> Stadio</span></div>
             <div class="col-md-3"><div style="background:#702b06;" class="categoria">&nbsp;</div><span class="text-categoria"> Concesionario</span></div>
              <div class="col-md-3"><div style="background:#00ddff;" class="categoria">&nbsp;</div><span class="text-categoria"> Instituto</span></div>
     ...
     <div class="padre buscador2">
        	<div class="hijo">
        		 <div class="col-md-3"><div style="background:red;" class="categoria">&nbsp;</div><span class="text-categoria"> Suspendida</span></div>        		
        	</div>
        </div>
    </nav>
...
<script>
	...
	//alert (data);
      ...
      right: 'agendaDay,agendaWeek,month'
        ...
        dia = date.format();
		/*$.post( "<?php //echo base_url();?>actividades/nueva/", { fcha: dia} );*/
