...
$(".delet_calendar").click(function(){
    //alert(id+'-'+actividad);
       if(confirm("¿estas seguro de eliminar esto?")){
          ...
          $.post("<?php  echo base_url()?>actividades/nueva/eliminar_calendarizacion", {id: id, actividad:actividad},
            function(data){
          $(".div_calendar").html(data);
          delete_calendarizacion();
...
function guardar(num)
    {
     ...
     $.post("<?php echo base_url()?>actividades/nueva/guardarPersona", {nombre: nombre,ap_pat:ap_pat, ap_mat: ap_mat, tipo:tipo, rut:rut},
    function(data){
        var numFilas = $("#PersonaSelect tr").length;
         if(data == 1)
         { 
...
function info(rutPer)
    ...
    //    var x = document.getElementById(e);
      //  alert(x);
      $.post("<?php echo base_url()?>actividades/nueva/buscarPersona", {rut: valor},
    function(data){
      var numFilas = $("#PersonaSelect tr").length;
