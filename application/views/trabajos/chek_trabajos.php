...
<div class="main">
    ...
    <nav class="navbar navbar-default nav-titulo">
        <div class="col-md-3">
            <h1 style="text-align:center;">CHECK TRABAJOS</h1>
        </div>
        <div class="col-md-3">
            <input class="form-control" type="date" id="txt_fecha" name="txt_fecha" value="<?php echo $fecha; ?>">
        </div>
    </nav>
    ...
    <script>
        ...
        function fecha() {
            ...
            $.post("<?php echo base_url() ?>trabajos/chek_trabajos/trabajos_fecha", {
                txt_fecha: txt_fecha
            }, function(data) {
