...
if(tipoGraf==1){
  ...
  data = {'desde':desde,'hasta':hasta,'gen':gen,'tipo':tipo};
...
if(tip_Socio == 3){
 ...
 data = {'tipo':tipoGraf , 'tipSoc' : tipSoc , 'tipoSocio' : tip_Socio};
  ...
  $.ajax({
    ...
    $("#detalle").append($('<table>').attr({id:'tableID',class:'table-bordered table-striped'}));
 ...
 $('input[name=tip_Socio]').change(function() {  
     ...
     gen = 0;
      ...
      $.ajax({
            ...
            data:{'tipo':tipoSocio,'gen':gen,'tipoGraf':tipoGraf},
           ...
           chart.setTitle({text: 'Clasificación de Socios'});
     ...
     if(tipoGraf == 2){
          ...
          $.ajax({
            ...
            data:{'tipo':tipo,'gen':gen,'tipoGraf':tipoGraf},
           ...
           chart.setTitle({text: 'Número de Socios por Género'});
        ...
        // console.log(data);
           ...
           chart.setTitle({text: 'Número de Cargas por Género'});
     ...
     $('#genero').change(function() {      
       ...
       $('#tableID').remove();     
          ...
          $.ajax({
           ...
           chart.setTitle({text: 'Número de Cargas por Edades'});
