        ...
        <table width="100%" border="0">
            <tbody>
                ...
                <?php if ($estado == "1") : ?>
                    ...
                    <tr>
                        <td align="left" class="" colspan="2"><?php echo 'Con de fecha de ' . $hooy; ?></td>
                    </tr>
                    <tr>

                        <td align="left" class="" colspan="2"><?php echo 'Regristro de socios incorporados desde: ' ?></td>
                    </tr>
                    <tr>

                        <td align="left" class="" colspan="2"><?php echo  formatFecha($desde) . ' hasta ' . formatFecha($hasta); ?></td>
                    </tr>
                ...
                <?php if ($estado == "2") : ?>
                    ...
                    <tr>
                        ...
                        <td align="left" class="" colspan="2"><?php echo 'Regristro de socios dados de baja desde: ' ?></td>
                    </tr>
                    <tr>
                ...
                <tr>
                    <td align="left" class="" colspan="2">Con un total de: <b><?php echo $totales ; ?></b> socios</td>
                </tr>
            ...
            <tbody>
                <?php foreach ($activos as $s) : ?>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <?php if ($estado == "1") : ?>
                            <td><?php echo formatFecha($s->fecha_registro) ?></td>

                        <?php endif; ?>
                        <?php if ($estado == "2") : ?>

                            <td><?php echo formatFecha($s->fecha_retiro) ?></td>
