        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="overflow: hidden;">
            ...
            <div class="col-md-6">
              ...
              <input maxlength="10"autocomplete="off"  type="text" class="form-control" name="rut_socio" id="rut_socio" placeholder="Ej: 11111111-1" value="<?php echo set_value('rut_socio'); ?>">
      ...
      <div class="col-sm-6">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="overflow: hidden;">
            ...
            <button id="guardarArch" type="button" class="btn btn-success">GUARDAR</button>

            <a href="<?php echo base_url(); ?>socios/inicio" type="button" class="btn btn-info">Volver</a>
...
<script type="text/javascript">
  ...
  $("#enviar").click(function() {
    ...
    $.post("<?php echo base_url() ?>socios/cambiacond/mostrar_socio", {
