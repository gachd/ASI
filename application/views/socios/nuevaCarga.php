  ...
  <div class="container-fluid">
    <div class="row fixed">
      ...
      <div class="col-sm-6">
        <div class="panel panel-default">
          <div class="panel-heading" style="overflow: hidden;">
            <button type="button" id="guardarArch" type="button" class="btn btn-success">GUARDAR</button>


            <button href="<?php echo base_url(); ?>socios/m_cargas" type="button" class="btn btn-info">VOLVER</button>
          </div>
        </div>
      </div>
