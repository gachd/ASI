 ...
 * ===============================================*/
 ...
 <div class="container-fluid">    
    ...
    <input maxlength="10" autocomplete="on" type="text" class="form-control" name="rut_socio" id="rut_socio" placeholder="Ej: 11111111-1" value="<?php echo set_value('rut_socio');?>">
...
//    $('#edit_socios').html('<div><img src="<?php  echo base_url()?>assets/images/loading.gif"/></div>');
        ...
        $.post("<?php  echo base_url()?>socios/gestionsocios/mostrar_socio", {
