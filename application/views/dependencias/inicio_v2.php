  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
     ...
     <!--************************* IMPRIMO EL CONTENIDO DE LA VENTANA *****************-->
       <div class="col-md-12" id="dep_edit">
...
$.datepicker.regional['es'] = {
 ...
 /* funcionalidad del modal editar*/
 function showinstalacion_edit() {
         element = document.getElementById("div_instalaciones_editar");
         check = document.getElementById("chk_instalacion_edit");
         if (check.checked) {
             element.style.display='block';
         }
         else {
 ...
 function showvegetacion_edit() {
         element = document.getElementById("div_vegetacion_edit");
         check = document.getElementById("chk_vegetacion_edit");
         if (check.checked) {
             element.style.display='block';
         }
         else {
 ...
 function showrecreacion_edit() {
         element = document.getElementById("div_recreacion_edit");
         check = document.getElementById("chk_recreacion_edit");
         if (check.checked) {
             element.style.display='block';
         }
         else {
