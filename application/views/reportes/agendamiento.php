    ...
    <table width="100%" border="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2">
            <h2>Listado agendadamiento StadioItaliano</h2>
          </td>
        ...
        <tr>
          ...
          <td align="center" colspan="4">
            <h2>Día <strong><?php echo $fecha1 ?></strong></h2>
          </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="mitabla">
      ...
      <tbody>
        ...
        foreach ($agendas as $value) {
          ...
          echo '<td>' . $value->nombre_sector . '</td>';
          ...
          if ($value->invitados != 0) {
            ...
            $cargas = $this->Socio_model->cargas_visita($visita);
            ...
            foreach ($cargas as $index) {
              ...
              echo '<td>' . $index->rut_acompanante . '</td>';

              echo '<td>' . $index->nombres . '</td>';

              echo '<td>' . $index->paterno . '</td>';

              echo '<td>' . $index->materno. '</td>';
