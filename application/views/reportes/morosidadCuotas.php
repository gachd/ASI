...
<div class="panel-heading">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="2"><h2>Informe de Socios con morosidad</h2></td> 
              <td></td>             
            </tr>
            <tr><td></td><td></td><td></td></tr>
            <tr><td align="left" colspan="2" ><?php echo 'Actualización de cuotas al '.$ayer; ?></td>
               ...
               (string) $rut = $a->prsn_rut;  
                ...
                foreach ($ult_pago as $u) {
                  if($u->ano < 2019 ){
                    ...
                    $saldo = $this->model_socios->saldoSocio($a->prsn_rut);
                        echo '<td>$' . $saldo . '</td>';
                        $cont++;
                  }
