<style>
 ...
 body{}
  ...
  font-family: monospace;
    ...
    padding-bottom: 8px;
    width: 150px;}
    table.turnos th {    background: #f7f7f7;
    border: 1px solid;
    text-align: center;}
    ...
    .sigla{text-align: center;width: 28px;}
    .desc_turnos{font-size: 12px; font-family: monospace;
    text-transform: uppercase;
    margin-top: 16px;}
    .horario{text-transform: uppercase;    padding: 5px;    min-width: 80px;}
</style>
<html>
<head>
    <?php 
        ...
        <table class="desc_turnos">
            <tr style="border:none;" style="font-family: monospace;font-size:12px;">
              <th style="text-align:left;" colspan="6"><?php echo $institucion; ?><br>
                Impreso el <?php echo ' '.iconv('ISO-8859-1', 'UTF-8', strftime('%A %e/%b/%g - %H:%I',  strtotime("".$hoy.""))).''; ?></th></tr>
