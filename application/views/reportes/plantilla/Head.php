...
body,html{
  ...
  #wrapper {    padding: inherit;}

.cont-sidebar{z-index: 1060;}
...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li style="text-align: center;"><img width="120" src="http://www.stadioitalianodiconcepcion.cl/ASI/assets/images/logo_instituciones.png"></li>
