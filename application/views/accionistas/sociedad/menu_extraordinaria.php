            ...
            <div class="modal-dialog  main container-fluid" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Correo Junta Extraordinaria</h4>
                    </div>
        ...
        <div class="modal fade " id="ver_detalle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-dialog  main container-fluid" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Detalle Junta Extraordinaria</h4>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade " id="modal_nueva_junta" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg main" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Nueva Junta Extraordinaria</h4>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">Datos Junta Extraordinaria</div>
                                    <div class="panel-body well">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="temas_junta">Temas Junta Extraordinaria</label>
                                                <input type="text" autocomplete="off" class="form-control" id="temas_junta" name="temas_junta" placeholder="Temas a tratar en Junta" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
    ...
    <script>
        ...
        function formatoFecha(texto) {
            ...
            if(texto){
                ...
                let fecha_formato = fecha[2] + "/" + fecha[1] + "/" + fecha[0];
