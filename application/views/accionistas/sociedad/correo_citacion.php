        ...
        <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td class="header">
              ...
              <!--   <table class="col425" align="left" border="0" cellpadding="0" cellspacing="0" style="width:50%; max-width: 425px;">  
            <tr>
              <td height="70">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;">
                      Llámenos para cualquier consulta<BR /> 41 239 0003
                    </td>
                  </tr>
                </table>
              </td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" class="footercopy">
                    <p>Stadio Italiano di Concepción 2021<br />
                      <span class="hide">Consultas a </span>
                  ...
                  <!--   <p style="font-size:10px;">Si no puede ver este mensaje haga <a href="http://www.stadioitalianodiconcepcion.cl/mailing/temporada%20estival2018.html">click
                        aqui</a></p> -->
                  </td>
                </tr>
                <tr>
                      ...
                      <tr>
                        <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                          <a href="http://www.facebook.com/">
                            <img src="" width="37" height="37" alt="Facebook" border="0" />
                          </a>
                        </td>
                        <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
