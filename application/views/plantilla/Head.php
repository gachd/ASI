...
<?php !isset($this->session->userdata['logueado']) ?   die(
  
  '
  
  
  Página con acceso restringido. 
  <a href="' . base_url() . 'Login" class="btn btn-warning">Click aquí para hacer login</a>
          ...
          <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
             <!-- <li style="text-align: center;"><img width="120" src="https://www.stadioitalianodiconcepcion.cl/ASI/assets/images/logo_instituciones.png"></li> -->
              ...
              <li style="text-align: center;"><a title="Los Tejos" href="<?=base_url('Calendario')?>" ><img width="120" src="https://www.stadioitalianodiconcepcion.cl/ASI/assets/images/logo_instituciones.png" alt="Los Tejos" /></a> </li>



              <li>
                <h4> <?php print_r($this->session->userdata('username'));  ?> </h4>
              ...
              <li>
                ...
                $usuario = $this->session->userdata('id'); // se llama rut del usuario en sesion activa
